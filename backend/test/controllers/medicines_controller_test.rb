...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference("Medicine.count") do
      post medicines_url, params: { medicine: { hour: @medicine.hour, memo: @medicine.memo, minute: @medicine.minute, name: @medicine.name, second: @medicine.second } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { hour: @medicine.hour, memo: @medicine.memo, minute: @medicine.minute, name: @medicine.name, second: @medicine.second } }
